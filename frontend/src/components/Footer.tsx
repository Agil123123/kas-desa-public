      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl text-white">Jimpitan Desa</span>
            </Link>
            <p className="text-gray-400 max-w-sm">
              Sistem informasi digital untuk pencatatan dan pengelolaan dana jimpitan RT/RW secara transparan, akurat, dan real-time.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Panduan Pengguna</a></li>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} Jimpitan Desa Digital. Seluruh hak cipta dilindungi.
          </p>
